...
# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/USER/Desktop/PythonWorkspace2/pygame_basic/background_quiz.png")

#캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/USER/Desktop/PythonWorkspace2/pygame_basic/character_quiz.png")
